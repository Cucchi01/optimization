...
function [xk, fk, gradfk_norm, k, xseq, btseq, internal_jseq, flag_converged, ...
    flag_armijo_always_satisfied, flag_enough_internal_steps] = truncated_newt_matrix_free(x0, f, gradf, h, fterm, kmax, internal_jmax, ...
    ...
    while k<kmax && gradfk_norm >= tolgrad 
        ...
        dj = rj;
        j = 0;
        % computes the product of Hessian with a vector without computing
        % explicitly the Hessian
        Hessf_vet_prod = @(xk, dir) (gradf(xk+h*dir)-gradf(xk))/h;
