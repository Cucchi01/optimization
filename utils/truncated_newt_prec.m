...
function [xk, fk, gradfk_norm, k, xseq, btseq, internal_jseq, flag_converged, ...
    flag_armijo_always_satisfied, flag_enough_internal_steps] = truncated_newt_prec(x0, f, gradf, Hessf, fterm, kmax, internal_jmax, ...
    ...
    while k<kmax && gradfk_norm >= tolgrad 
        ...
        % computation of the matrix for the preconditioning
        [L, U, P] = ilu(sparse(Bk));
        y0 = U\(L\(P*rj));
        yj = y0;
